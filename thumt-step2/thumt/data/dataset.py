...
def get_training_dialogue_input(filenames0, filenames1, filenames2, filenames3, filenames4, filenames5, params):
    ...
    with tf.device("/cpu:0"):
        ...
        dialog_features["sp_labels"] = label_table.lookup(dialog_features["sp_labels"])
        dialog_features["dia_labels"] = label_table.lookup(dialog_features["dia_labels"])

        dialog_features["sp_labels"] = tf.to_int32(dialog_features["sp_labels"])
        dialog_features["dia_labels"] = tf.to_int32(dialog_features["dia_labels"])
